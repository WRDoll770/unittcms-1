...
export default function Page({ params }: PageType) {
  if (process.env.SIGNUP_ENABLED === 'false') {
    ...
    return (
      <>
        <AuthPage isSignup={false} messages={messages} locale={params.locale as LocaleCodeType} ssoEnabled={true} signupEnabled={false} />
      </>
    );
  }
  else {
    ...
    return (
      <>
        <AuthPage isSignup={true} messages={messages} locale={params.locale as LocaleCodeType} ssoEnabled={true} signupEnabled={true} />
      </>
    );
  }
}
